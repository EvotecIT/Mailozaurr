#### 1.0.7 - 2025.06.11
##### What's changed
- Fixes [SkipCertificateValidatation does not seem to work](https://github.com/EvotecIT/Mailozaurr/issues/53)

**Full Changelog**: https://github.com/EvotecIT/Mailozaurr/compare/v1.0.5...v1.0.7

#### 1.0.6 - 2025.05.17

##### What's new
- Fixes [Adding attachment >3 MB not possible if no client secret is used](https://github.com/EvotecIT/Mailozaurr/issues/55) in #64
- Fixes [When path to attachment is empty error should be handled better when using Graph](https://github.com/EvotecIT/Mailozaurr/issues/54) in #64

**Full Changelog**: https://github.com/EvotecIT/Mailozaurr/compare/v1.0.4...v1.0.6
...
**Full Changelog**: https://github.com/EvotecIT/Mailozaurr/compare/v1.0.4...v1.0.5

#### 1.0.4 - 2024.10.29

##### What's Changed
- Removed single dependency, which should solve [#58](https://github.com/EvotecIT/Mailozaurr/issues/58)

#### 1.0.3 - 2024.10.18

##### What's Changed
* Bump DLLs to most recent versions before 2.0 by @PrzemyslawKlys in https://github.com/EvotecIT/Mailozaurr/pull/57

**Full Changelog**: https://github.com/EvotecIT/Mailozaurr/compare/v1.0.2...v1.0.3
