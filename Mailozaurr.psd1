@{
    ...
    CmdletsToExport      = @('Connect-EmailGraph', 'Connect-IMAP', 'Connect-OAuthGoogle', 'Connect-OAuthO365', 'Connect-POP3', 'ConvertFrom-EmlToMsg', 'ConvertFrom-MsgToEml', 'ConvertFrom-OAuth2Credential', 'ConvertTo-GraphCertificateCredential', 'ConvertTo-GraphCredential', 'ConvertTo-MailgunCredential', 'ConvertTo-OAuth2Credential', 'ConvertTo-SendGridCredential', 'Disconnect-EmailGraph', 'Disconnect-IMAP', 'Disconnect-POP3', 'Get-EmailGraphMessage', 'Get-IMAPFolder', 'Get-IMAPMessage', 'Get-EmailGraphFolder', 'Get-EmailGraphMessageAttachment', 'Get-POP3Message', 'Import-MailFile', 'Move-GraphMessage', 'Move-IMAPMessage', 'Save-GraphMessage', 'Save-GraphMessageAttachment', 'Save-IMAPMessage', 'Save-IMAPMessageAttachment', 'Save-POP3Message', 'Save-POP3MessageAttachment', 'Send-EmailMessage', 'Set-GraphMessage', 'Test-EmailAddress', 'Wait-IMAPMessage', 'Wait-GraphMessage', 'Wait-POP3Message', 'Search-GraphMailbox', 'Remove-GraphMessage', 'Search-IMAPMailbox', 'Search-POP3Mailbox', 'Remove-IMAPMessage', 'Remove-POP3Message', 'Clear-IMAPJunk', 'Clear-GraphJunk')
    CompanyName          = 'Evotec'
