@{
    ...
    CmdletsToExport      = @('Connect-IMAP', 'Connect-POP', 'ConvertFrom-EmlToMsg', 'Disconnect-IMAP', 'Disconnect-POP', 'Get-IMAPFolder', 'Get-IMAPMessage', 'Get-POPMessage', 'Import-MailFile', 'Save-POPMessage', 'Send-EmailMessage', 'Test-EmailAddress', 'Get-MailFolder', 'Get-MailMessageAttachment', 'Get-MailMessage', 'Save-MailMessage')
    CompanyName          = 'Evotec'
    ...
    FunctionsToExport    = @('Connect-oAuthGoogle', 'Connect-oAuthO365', 'ConvertTo-GraphCredential', 'ConvertTo-OAuth2Credential', 'ConvertTo-SendGridCredential')
