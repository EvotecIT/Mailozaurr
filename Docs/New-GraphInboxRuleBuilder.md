...
### __AllParameterSets
```powershell
New-GraphInboxRuleBuilder -DisplayName <string> [-Sequence <int>] [-Enabled] [-MoveToFolder <string>] [-CopyToFolder <string>] [-Delete] [-ForwardTo <string[]>] [-StopProcessing] [-SenderContains <string[]>] [-RecipientContains <string[]>] [-SubjectContains <string[]>] [-BodyContains <string[]>] [-Importance <string>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
New-GraphInboxRuleBuilder -DisplayName 'Name'
```
