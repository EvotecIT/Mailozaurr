...
- [MailProfile.cs](../Sources/Mailozaurr.Host/MailProfile.cs)
- [MailProfileKind.cs](../Sources/Mailozaurr.Host/MailProfileKind.cs)
- [MailProfileSettingsKeys.cs](../Sources/Mailozaurr.Host/MailProfileSettingsKeys.cs)
- [MailSecretNames.cs](../Sources/Mailozaurr.Host/MailSecretNames.cs)
...
Default capabilities are defined in [MailCapabilityCatalog.cs](../Sources/Mailozaurr.Host/MailCapabilityCatalog.cs).
...
The shared validator lives in [MailProfileValidator.cs](../Sources/Mailozaurr.Host/MailProfileValidator.cs).
...
The path resolver is implemented in [MailApplicationPaths.cs](../Sources/Mailozaurr.Host/MailApplicationPaths.cs).
...
`Mailozaurr.Host` is an internal, non-packable composition layer used by the CLI and MCP host. Until the CLI package is publicly released, run it from this checkout or from a locally built PowerForge artifact.
