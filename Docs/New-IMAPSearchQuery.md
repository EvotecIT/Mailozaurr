...
### -Answered
Only answered messages are matched.
...
### -Flagged
Only flagged messages are matched.
...
### -FromContains
Filters messages by sender text.
...
### -MessageContains
Filters messages where any searchable message content contains this text.
...
### -Seen
Only read messages are matched.
...
### -ToContains
Filters messages by recipient text.
...
### -Unanswered
Only unanswered messages are matched.
...
### -Unflagged
Only unflagged messages are matched.
...
### -Unseen
Only unread messages are matched.
