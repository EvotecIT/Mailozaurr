...
### OAuth2
```powershell
Connect-POP3 [-Server <string>] [-Port <int>] [-Credential <pscredential>] [-SkipCertificateRevocation] [-SkipCertificateValidation] [-Options <SecureSocketOptions>] [-EnableExplicit] [-TimeOut <int>] [-RetryCount <int>] [-RetryDelayMilliseconds <int>] [-RetryDelayBackoff <double>] [-OAuth2] [<CommonParameters>]
```

### Credential
```powershell
Connect-POP3 [-Server <string>] [-Port <int>] [-Credential <pscredential>] [-SkipCertificateRevocation] [-SkipCertificateValidation] [-Options <SecureSocketOptions>] [-EnableExplicit] [-TimeOut <int>] [-RetryCount <int>] [-RetryDelayMilliseconds <int>] [-RetryDelayBackoff <double>] [<CommonParameters>]
```

### ClearText
```powershell
Connect-POP3 -UserName <string> -Password <string> [-Server <string>] [-Port <int>] [-SkipCertificateRevocation] [-SkipCertificateValidation] [-Options <SecureSocketOptions>] [-EnableExplicit] [-TimeOut <int>] [-RetryCount <int>] [-RetryDelayMilliseconds <int>] [-RetryDelayBackoff <double>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Connect-POP3 -UserName 'Name' -Password 'Value'
```


### EXAMPLE 2
```powershell
Connect-POP3 -Credential Get-Credential
```
...
### -EnableExplicit
When Options remains Auto, this switch forces the use of StartTls.
...
### -Options
Specifies the secure socket options for the POP3 connection. Default is Auto. Options: None, Auto, SslOnConnect, StartTls, StartTlsWhenAvailable.
...
### -Port
Specifies the port to use for the POP3 connection. Default is 995 (POPS).
...
### -Server
Specifies the POP3 server hostname or IP address to connect to.
...
- CmdletDisconnectPOP3
- CmdletGetPOP3Message
