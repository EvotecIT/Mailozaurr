...
### __AllParameterSets
```powershell
Remove-MailProfile [-ProfileId] <string> [-ProfileDirectory <string>] [-SecretDirectory <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Remove-MailProfile -ProfileDirectory 'Value'
```
