...
### __AllParameterSets
```powershell
Get-JMAPMailbox [-ProfileId] <string> [-ProfileDirectory <string>] [-SecretDirectory <string>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Get-JMAPMailbox -ProfileDirectory 'Value'
```
