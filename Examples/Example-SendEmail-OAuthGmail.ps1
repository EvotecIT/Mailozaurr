...
$oAuth2 = Connect-oAuthGoogle -ClientID $ClientID -ClientSecret $ClientSecret -GmailAccount 'evot@gmail.com'
...
Send-EmailMessage -From @{ Name = "Przemysław Kłys"; Email = 'evot@gmail.com' } -To 'test@evotec.pl' `
    ...
    -Subject 'This is another test email' -SecureSocketOptions Auto -oAuth $oAuth2