...
public sealed class GraphSearchRequest {
    /// <summary>Entity types to search (for example, message).</summary>
...
/// <summary>Payload for move and copy operations in Graph.</summary>
...
/// <summary>Payload to mark messages read or unread.</summary>
...
/// <summary>Payload to flag or unflag messages.</summary>
...
public sealed class GraphSetFlagRequestFlag {
    /// <summary>Flag status (for example, flagged or notFlagged).</summary>
