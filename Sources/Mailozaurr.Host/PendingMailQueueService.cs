...
public sealed class PendingMailQueueService : IMailQueueService {
    ...
    private static Task DefaultProcessAsync(
        ...
        var senderFactory = new PendingMessageSenderFactory(new Dictionary<EmailProvider, IPendingMessageSender> {
            [EmailProvider.Gmail] = new GmailPendingMessageSender(),
            [EmailProvider.Graph] = new GraphPendingMessageSender()
        });
        var processor = new PendingMessageProcessor(repository, senderFactory, observer: observer,
